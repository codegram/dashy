defmodule DashyWeb.Components.Button do
  ...
  def render(assigns) do
    ...
    <button
      ...
      phx-value-val="{{@value}}"
      type="button"
      class={{"inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white focus:outline-none focus:ring-2 focus:ring-offset-2", "bg-indigo-600 hover:bg-indigo-700 focus:ring-indigo-500": @color == "primary" && @background == "primary",
